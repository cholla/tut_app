...
describe UsersController do
  ...
  describe "GET 'index'" do
    ...
    describe "for sign-in users" do
      before(:each) do
        ...
        second = Factory(:user, :email => "one2@example.com")
        third = Factory(:user, :email => "two2@example.com")
  ...
  describe "GET 'show'" do
    ...
    it "should show the user's microposts" do
      ...
      mp2 = Factory(:micropost, :user => @user, :content => "stuff")
      get :show, :id => @user
  ...
  describe "PUT 'update'" do
    ...
    describe "success" do
      before(:each) do
        @attr = { :name => "New name", :email => "wh@example.com", 
